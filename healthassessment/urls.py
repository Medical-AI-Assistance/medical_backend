...
urlpatterns = [
    ...
    path("sections/<uuid:reference_id>/", views.SectionDetailAPIView.as_view(), name="section-detail"),
    path("sections/<uuid:reference_id>/update/", views.SectionUpdateAPIView.as_view(), name="section-update"),
    path("sections/<uuid:reference_id>/delete/", views.SectionDeleteAPIView.as_view(), name="section-delete"),
    ...
    path("questions/<uuid:reference_id>/", views.QuestionDetailAPIView.as_view(), name="question-detail"),
    path("questions/<uuid:reference_id>/update/", views.QuestionUpdateAPIView.as_view(), name="question-update"),
    path("questions/<uuid:reference_id>/delete/", views.QuestionDeleteAPIView.as_view(), name="question-delete"),
    ...
    path("options/<uuid:reference_id>/", views.OptionDetailAPIView.as_view(), name="option-detail"),
    path("options/<uuid:reference_id>/update/", views.OptionUpdateAPIView.as_view(), name="option-update"),
    path("options/<uuid:reference_id>/delete/", views.OptionDeleteAPIView.as_view(), name="option-delete"),
